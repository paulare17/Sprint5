        ...
        <div className={`card `}>
          ...
          <div className="card-body">
            ...
            <div className="card-footer">
              <div className="dots">
                <span className={`${step === 0 ? 'dot active' : 'dot'}`} onClick={() => setStep(0)}></span>
                <span className={`${step === 1 ? 'dot active' : 'dot'}`} onClick={() => setStep(1)}></span>
                <span className={`${step === 2 ? 'dot active' : 'dot'}`} onClick={() => setStep(2)}></span>
              </div>
